<div class="hotels index">
	...
	<tr>
		...
		<td><?php echo h($hotel['Hotel']['legal_name']); ?>&nbsp;</td>
		<td><?php echo h($hotel['Hotel']['business_name']); ?>&nbsp;</td>
		<td><?php echo h($hotel['Hotel']['country']); ?>&nbsp;</td>
		<td><?php echo h($hotel['Hotel']['state']); ?>&nbsp;</td>
		<td><?php echo h($hotel['Hotel']['phone']); ?>&nbsp;</td>
		<td class="actions">
